...
<div dir="rtl" align="justify">
    این پکیج امکان اتصال <a href="https://raygansms.com/" target="_blank" >RayganSms API</a> به فریم ورک هایی که جهت نصب پکیج ها از <a href="https://alireza-abdolmaleki.ir" target="_blank" >composer</a> و از استاندارد  <a href="https://alireza-abdolmaleki.ir/" target=_blank" >PSR-4</a> جهت <a href="https://alireza-abdolmaleki.ir/" target="_blank">autoload</a>  نمودن کلاس ها استفاده می نمایند همانند (Laravel,Yii,symfony)   را فراهم می سازد.
...
```bash
composer require alirezaabdolmaleki/raygan-sms
```
...
$password = '*******';
$phone_number = '*******';;
$sms = new \Alirezaabdolmaleki\RayganSms\Sms($user_name,$password,$phone_number);
```
<div dir="rtl">
...
// config/app.php
...
Alirezaabdolmaleki\RayganSms\RayganSmsServiceProvider::class,
...
'RayganSms' => Alirezaabdolmaleki\RayganSms\Facades\RayganSms::class
...
```
...
<div dir="rtl">
    جهت استفاده از سیستم اعلانات (<a href="https://laravel.com/docs/5.7/notifications" >Notefications</a>)  لاراول،  پکیج <a href="https://github.com/alirezaabdolmalekiRaygansmsChannel" >raygan-sms-notification-channel</a>  را نصب و طبق مستندات مربوطه عمل نمائید.
</div>
