...
namespace Alirezaabdolmaleki\RayganSms;
...
class Sms
{
    ...
    public function __construct($user_name, $password, $phone_number)
    {
        ...
        $this->url_send_auto_auth_code = 'https://smspanel.Alirezaabdolmaleki.ir/AutoSendCode.ashx';
        $this->url_check_auth_code = 'https://smspanel.Alirezaabdolmaleki.ir/CheckSendCode.ashx';
        $this->url_send_auth_code = 'https://smspanel.Alirezaabdolmaleki.ir/SendMessageWithCode.ashx';
